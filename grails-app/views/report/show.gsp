            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="report.answers.label" default="Answers" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="report.person.label" default="Person" /></td>
