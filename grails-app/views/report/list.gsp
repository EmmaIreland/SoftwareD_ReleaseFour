                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="report.person.label" default="Person" /></th>
                        
                            <th><g:message code="report.survey.label" default="Survey" /></th>
                    ...
                    <g:each in="${reportInstanceList}" status="i" var="reportInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: reportInstance, field: "person")}</td>
                        
                            <td>${fieldValue(bean: reportInstance, field: "survey")}</td>
