					...
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="name"><g:message
										code="person.name.label" default="Name" />
							</label></td>
							<td valign="top"
								class="value ${hasErrors(bean: personInstance, field: 'name', 'errors')}">
								<g:textField name="name" value="${personInstance?.name}" /></td>
						</tr>
						...
						<tr class="prop">
							...
							<td valign="top"
								...
								<g:textField name="email" value="${personInstance?.email}" /></td>
						</tr>

						<tr class="prop">
							<td valign="top" class="name"><label for="enrollments"><g:message
										code="person.enrollments.label" default="Enrollments" />
							</label></td>
							<td valign="top"
								class="value ${hasErrors(bean: personInstance, field: 'enrollments', 'errors')}">
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="memberships"><g:message
										code="person.memberships.label" default="Memberships" />
							</label></td>
							<td valign="top"
								class="value ${hasErrors(bean: personInstance, field: 'memberships', 'errors')}">

								<ul>
									<g:each in="${personInstance?.memberships?.team}" var="m">
										<li><g:link controller="team" action="show" id="${m.id}">
												${m?.encodeAsHTML()}
											</g:link>
										</li>
									</g:each>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="ownedCourses"><g:message
										code="person.ownedCourses.label" default="Owned Courses" />
							</label></td>
							<td valign="top"
								class="value ${hasErrors(bean: personInstance, field: 'ownedCourses', 'errors')}">
